...
export function AssistantQuickPanel({ conversationId, pathname }: Props) {
  ...
  }, [conversationId, input, pathname, sending]);
    ...
    <div className="flex flex-col flex-1 min-h-0">
      ...
      >
        ...
        <button
          ...
          className="h-9 px-3 rounded-lg bg-amber-500 hover:bg-amber-600 disabled:opacity-50 text-white flex items-center text-sm"
        >
