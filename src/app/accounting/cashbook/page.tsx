        ...
        {(Object.keys(ACCOUNT_META) as AccountKey[]).map((key) => {
          ...
          return (
            <button
              ...
              disabled={!summary}
              className={cn(
                "text-right rounded-xl p-4 transition-all border-2 disabled:opacity-60 disabled:cursor-not-allowed",
                isActive
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <Icon
                  size={22}
                  className={isActive ? "text-gold" : "text-primary/70"}
                />
              </div>
              <p
                className={cn(
              ...
              >
                {formatAmount(bal)} <span className="text-sm font-normal">د.أ</span>
              </p>
              <p
                className={cn(
                  "text-[11px] mt-1",
