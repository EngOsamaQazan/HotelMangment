    ...
    <>
      <style>{`
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        body { direction:rtl; }
        .contract-page { width:100%; max-width:210mm; margin:5mm auto; padding:4mm 4mm; background:#fff; box-shadow:0 2px 15px rgba(0,0,0,0.15); font-family:'Tajawal','Arial',sans-serif; font-size:11px; line-height:1.45; color:#1a1a1a; direction:rtl; }
        @media (min-width:768px) { .contract-page { padding:8mm 12mm; } }
        @media print {
        ...
        .info-grid { display:grid; grid-template-columns:1fr; gap:2px 15px; margin:3px 0; }
        ...
        .payment-grid { display:grid; grid-template-columns:1fr; gap:5px; text-align:center; }
        @media (min-width:500px) { .payment-grid { grid-template-columns:1fr 1fr 1fr; } }
        ...
        .signatures { display:grid; grid-template-columns:1fr; gap:20px; margin-top:10px; padding-top:8px; border-top:2px solid #1a5276; }
        @media (min-width:500px) { .signatures { grid-template-columns:1fr 1fr; } }
        ...
        .print-btn { position:fixed; bottom:20px; left:50%; transform:translateX(-50%); background:#1a5276; color:#fff; border:none; padding:12px 30px; font-size:14px; font-family:'Tajawal',sans-serif; font-weight:700; border-radius:12px; cursor:pointer; box-shadow:0 3px 15px rgba(0,0,0,0.3); z-index:1000; }
        @media (min-width:768px) { .print-btn { position:fixed; top:15px; left:15px; bottom:auto; transform:none; border-radius:6px; } }
