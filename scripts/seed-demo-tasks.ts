...
const BOARDS: DemoBoard[] = [
    ...
    cards: [
      {
        ...
        description:
          "الضيف أبلغ الاستقبال صباحاً عن عدم برودة المكيف. ريموت المكيف يعمل والأنوار تضيء لكن الهواء دافئ. يحتمل نقص فريون أو مشكلة مكثّف.",
        priority: "urgent",
        dueInDays: 0,
        labels: ["تكييف", "عاجل"],
        assignees: "owner",
        ...
        comments: [
          {
            body: "الضيف مستعجل — عنده اجتماع عمل بعد الظهر.",
            daysAgo: 0,
          },
        ],
      },
...

  {
    ...
    color: "#0ea5e9",
    columns: ["قائمة الوصول", "قيد التحضير", "بانتظار تأكيد الضيف", "جاهز"],
    labels: [
    ...
    cards: [
      {
        ...
        description:
          "الأستاذ ماهر العبد الله — ضيف متكرر. يطلب دائماً: ماء بارد، فواكه موسمية، وسادتين إضافيتين، وضبط الحرارة على 21.",
        priority: "urgent",
        dueInDays: 0,
        labels: ["VIP", "طلب خاص"],
        checklist: [
        ...
        comments: [
          {
            body: "تواصلت مع الضيف — قادم من مطار الملكة علياء، سيصل تقريباً 5:15.",
            daysAgo: 0,
          },
        ],
      },
...

  {
    ...
    cards: [
      ...
      {
        column: "مطلوب تنظيف",
        title: "الجناح الملكي 801 — تعقيم عميق قبل ضيف VIP",
        description:
          "ضيف دبلوماسي قادم مساء الغد. المطلوب تعقيم عميق (شفط السجاد، تلميع الخشب، تبديل كامل للمفروشات).",
        priority: "high",
        dueInDays: 1,
  ...
  {
    name: "تجربة الضيف والشكاوى",
    description:
      "متابعة ملاحظات الضيوف، الشكاوى، التقييمات، وتحسينات الخدمة.",
    color: "#a855f7",
    columns: ["جديد", "قيد المعالجة", "بانتظار رد الضيف", "مغلق"],
    labels: [
    ...
    cards: [
      {
        ...
        description:
          "الضيفة سيّدة أبلغت الاستقبال في منتصف الليل بأن الغرفة المجاورة صاخبة. تم التواصل مع ضيوف 311 وهدأت الأجواء، لكن الضيفة طلبت تقييم الموضوع صباحاً.",
        priority: "high",
        dueInDays: 0,
        labels: ["شكوى"],
        comments: [
      ...
      },
      {
        ...
        description:
          'الضيف ذكر "انتظار 25 دقيقة على الاستقبال يوم الجمعة الماضي". نحتاج الرد علناً + تحليل داخلي.',
        priority: "med",
        dueInDays: 1,
      ...
      },
      {
        ...
        description:
          "الضيف الأستاذ عمر أبلغ مدير المطعم. تم الاعتذار وتقديم قسائم مشروبات مجانية لبقية الإقامة.",
        priority: "high",
        dueInDays: 0,
        labels: ["شكوى", "تعويض"],
        checklist: [
      ...
      },
      {
        ...
        description:
          "ضيفان ذكرا ضعف الإشارة. تم إبلاغ فريق الـ IT بالتحقّق من access point الدور.",
        priority: "med",
        dueInDays: 2,
        labels: ["ملاحظة"],
      },
      {
        column: "بانتظار رد الضيف",
      ...
      },
      {
        ...
        description:
          "استُبدل المكيف بالكامل، تواصلنا مع الضيف وقدّمنا خصم 20% على زيارته القادمة. أغلق الملف.",
        priority: "med",
        labels: ["شكوى", "تعويض"],
        completedDaysAgo: 4,
      },
